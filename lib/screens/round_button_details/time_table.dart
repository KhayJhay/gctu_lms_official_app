...
import 'package:gctu_official_app/screens/round_button_details/te_timetable_screen.dart';
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        RichText(text: TextSpan(
                          children: [
                            TextSpan(text: ("View Timetable"), style: TextStyle(
                                fontWeight: FontWeight.w900,
                                fontSize: 20,
                                color: Colors.deepPurple),),
                            TextSpan(text: ("\n For The Programs You're Offering"),
                              style: TextStyle(
                                color: Colors.deepPurple,
                    ...
                    SliverPadding(
                      ...
                      sliver: SliverGrid.count(
                          ...
                          children: <Widget>[
                            ...
                            GestureDetector(
                              onTap: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Te_timetable_screen())
                                );
                              },
                              child: Container(
                                decoration: BoxDecoration(
