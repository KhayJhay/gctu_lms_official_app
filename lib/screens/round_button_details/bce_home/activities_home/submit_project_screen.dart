...
class Submit_Project_Screen extends StatefulWidget {
  @override
  _Submit_Project_ScreenState createState() => _Submit_Project_ScreenState();
}

class _Submit_Project_ScreenState extends State<Submit_Project_Screen> {
  UploadTask? task;
  File? file;
  int? number;
  String url = "";
  ...
  Future uploadFile() async {
    ...
    await FirebaseFirestore.instance.collection("Submittedfile").doc().set({
      'fileUrl': url,
