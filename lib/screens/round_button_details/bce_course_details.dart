...
import 'package:gctu_official_app/screens/round_button_details/bce_home/activities_home/activities_home_screen.dart';
import 'package:gctu_official_app/screens/round_button_details/bce_home/activities_home/submit_project_screen.dart';
...
class Bce_Course_Details extends StatefulWidget {
  @override
  _Bce_Course_DetailsState createState() => _Bce_Course_DetailsState();
}

class _Bce_Course_DetailsState extends State<Bce_Course_Details> {
  @override
                              ...
                              children: <Widget>[
                                InkWell(
                                  child: Container(
                                    ...
                                    child: IconButton(
                                      icon : Icon(
                                        FontAwesomeIcons.upload, color: Colors.white, size: 30,
                                      ),
                                      onPressed: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=> Submit_Project_Screen()));
                                      },
                                    ),
                                  ),
                                  onTap: (){
                                ...
                                SizedBox(height: 8,),
                                Text("Submit",style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.deepPurple),
                                ),
                              ],
                            ),
                          ),
