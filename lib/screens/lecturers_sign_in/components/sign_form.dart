...
import 'package:gctu_official_app/screens/lecturers_sign_in/admin_login_sucess.dart';
  ...
  void signIn(String email, String password) async
  {
    if(_formKey.currentState!.validate())
    {
      await _auth
        ...
        Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => Admin_Login_Success())),
      }).catchError((e){
