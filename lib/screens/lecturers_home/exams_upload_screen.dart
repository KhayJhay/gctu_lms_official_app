...
class Exams_Upload_Screen extends StatefulWidget {
  @override
  _Exams_Upload_ScreenState createState() => _Exams_Upload_ScreenState();
}

class _Exams_Upload_ScreenState extends State<Exams_Upload_Screen> {
  UploadTask? task;
  File? file;
  int? number;
  String url = "";
  ...
  Future uploadExams() async {
    number = Random().nextInt(10);
    if (file == null) return;

    final fileName = basename(file!.path);
    final destination = 'exams/$fileName';
    ...
    await FirebaseFirestore.instance.collection("exams").doc().set({
      'fileUrl': url,
