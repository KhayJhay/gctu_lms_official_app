...
import 'files_upload_screen.dart';
import 'notify_users_screen.dart';
class Bsm_Dashboard_screen extends StatelessWidget {
  @override
                            ...
                            Container(
                              child: Column(
                                children: <Widget>[
                                  ...
                                  SizedBox(height: 8,),
                                  Text("Upload files", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.deepPurple),),
                                ],
                              ),
                            ),
                            Container(
                                ...
                                children: <Widget>[
                                  GestureDetector(
                                    child: Container(
                                      ...
                                      child: IconButton(
                                        icon : Icon(
                                          Icons.slow_motion_video_outlined, color: Colors.white, size: 30,
                                        ),
                                        onPressed: (){
                                        },
                                      ),
                                  ...
                                  SizedBox(height: 8,),
                                  Text("Upload Video",style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.deepPurple),
                                  ),
                                ],
                              ),
                            ),
