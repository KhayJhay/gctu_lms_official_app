...
class Assignment_Upload_Screen extends StatefulWidget {
  @override
  _Assignment_Upload_ScreenState createState() => _Assignment_Upload_ScreenState();
}

class _Assignment_Upload_ScreenState extends State<Assignment_Upload_Screen> {
  UploadTask? task;
  File? file;
  int? number;
  String url = "";
                                  ...
                                  Container(
                                    child: Row(
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            Text("Upload Assignment to Cloud",
                                              style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 16,
                                              ),
  ...
  Future uploadAssignment() async {
    ...
    await FirebaseFirestore.instance.collection("assignment").doc().set({
      'fileUrl': url,
